...
public class GraphPannel extends JPanel {
    ...
    public boolean V_isVisible = true;
    public boolean mA_isVisible = true;

    float selectionStart = (float) 0;
    float selectionEnd = (float) 0;
    float mousePosition_X = 0;

    boolean mouseIsOnPannel;
    ...
    public GraphPannel(){
        ...
        this.addMouseMotionListener(new MouseMotionAdapter() {
            ...
            public void mouseMoved(MouseEvent e) {
                super.mouseMoved(e);
                mousePosition_X = (float)e.getX()/getWidth();
                //System.out.println(mousePosition);
                mouseIsOnPannel = true;
            }
        });
